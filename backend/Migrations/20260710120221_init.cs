        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CandidateId = table.Column<string>(type: "varchar(255)", nullable: false),
                    AttributeId = table.Column<int>(type: "int", nullable: false),
                    ValueString = table.Column<string>(type: "longtext", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileAttributes", x => new { x.CandidateId, x.AttributeId });
                    table.ForeignKey(
                        name: "FK_ProfileAttributes_AspNetUsers_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
