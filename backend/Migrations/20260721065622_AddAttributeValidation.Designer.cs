...
namespace Backend.Api.Migrations
{
    ...
    [Migration("20260721065622_AddAttributeValidation")]
    partial class AddAttributeValidation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Api.Data.Entities.AttributeValidation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AttributeId", "ValidationType")
                        .IsUnique();

                    b.ToTable("AttributeValidations");
                });
            ...
            modelBuilder.Entity("Backend.Api.Data.Entities.PositionMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PositionMessages", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Api.Data.Relations.LikesResume", b =>
                {
                    ...
                    b.HasKey("UserId", "ResumeId");

                    b.HasIndex("ResumeId");

                    b.ToTable("LikesResume", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Api.Data.Relations.LikesResume", b =>
                {
                    b.HasOne("Backend.Api.Data.Entities.Resume", "Resume")
                        .WithMany("Likes")
                        .HasForeignKey("ResumeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Api.Data.ApplicationUser", "User")
                        .WithMany("ResumeLikes")
