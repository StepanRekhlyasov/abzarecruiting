...
import { useAttributesTable, type AttributeTableFilters } from '../model'
...
export function AttributesFilterModal() {
  ...
  const [draft, setDraft] = useState<AttributeTableFilters>(appliedFilters)
  ...
  return (
    <AbzaModal
      ...
      config={{
        ...
        submitLabel: t('attributes.filter.apply'),
        cancelLabel: t('attributes.filter.cancel'),
      }}
      secondaryLabel={t('attributes.filter.reset')}
